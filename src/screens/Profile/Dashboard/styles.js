...
export const styles = StyleSheet.create( {
    ...
    avatar: { position: 'absolute', marginTop: (height * 0.1279310344827586) / 2 - 20, width: height * 0.1279310344827586, height: height * 0.1279310344827586, borderRadius: height * 0.1279310344827586, marginLeft: width - (0.1896551724137931 * height) },
