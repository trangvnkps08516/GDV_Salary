  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.body}>
        ...
        <MenuItem style={{ marginTop: fontScale(60) }} title={text.salaryAverage} titleMenuStyle={{ paddingTop: fontScale(17) }} icon={images.salaryByMonth} width={width - fontScale(60)} onPress={() => navigation.navigate("AdminAvgIncome")} />
