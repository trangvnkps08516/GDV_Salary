        ...
        <View
            style={[styles.container, props.style]}>
            {
                props.item.detail == "true" ?
                    <TouchableOpacity key={index} style={{ flexDirection: "row", paddingVertical: fontScale(6) }} onPress={props.onPress}>
                    ...
                    :
                    <View key={index} style={{ flexDirection: "row", paddingVertical: fontScale(6) }}>
                        <View style={{ flexDirection: "row" }}>
                            {
                                fields.map((item, i) =>
                                    <View key={i} style={{ width: widthArray && widthArray[i], justifyContent: "center" }}>
